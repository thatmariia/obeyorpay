...
class MainUserStoreModel: Identifiable, Equatable, Hashable {
    
    // conforms to Equatable
    static func == (lhs: MainUserStoreModel, rhs: MainUserStoreModel) -> Bool {
